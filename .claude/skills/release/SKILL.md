...
- Make the curl installer work: `curl -fsSL https://raw.githubusercontent.com/juanre/beadhub/main/bdh/install.sh | sh`

## Instructions

1. First, check the current state:
   ```bash
   cd /Users/juanre/prj/beadhub-all/beadhub
   git status
...
4. Provide the URL to watch the release workflow:
   `https://github.com/juanre/beadhub/actions`
...
- [ ] README install URL points to `juanre/beadhub`
- [ ] No uncommitted changes on main

## After Release

The release workflow takes ~2-3 minutes. Once complete:
- Binaries available at: `https://github.com/juanre/beadhub/releases`
